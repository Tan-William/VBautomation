...
$settings['apass'] = 'freegift';

// Website title
$settings['website_title'] = "Visual Basic Automation";

// Website URL
$settings['website_url'] = 'https://github.com/william-pbTan/VBautomation.git';

// Guestbook title
$settings['gbook_title'] = "My Guestbook";

// Your e-mail address.
$settings['admin_email'] = 'tan.sarawak@gmail.com';

// URL of the gbook.php file.
$settings['gbook_url'] = 'https://github.com/william-pbTan/VBautomation.git/gbook/gbook.php';

// If you want to use a logical anti-SPAM question type it here
$settings['Are you a human (yes or no)?'] = '1';
...
$settings['logfile'] = 'freegifts12345.txt';
...
$settings['filter_sum'] = '12345abcde';
